...
async function authorize() {
    const credentials = JSON.parse(fs.readFileSync(process.env.ROOT_DIRECTORY + 'credentials.json', 'utf-8'));
    ...
    const token = fs.readFileSync(process.env.ROOT_DIRECTORY + 'token.json', 'utf-8');
